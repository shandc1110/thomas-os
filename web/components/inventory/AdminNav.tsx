...
const NAV_ITEMS = [
  ...
  { href: "/admin/inventory/assortment", label: "Assortment" },
  { href: "/admin/inventory/storefront-readiness", label: "Storefront" },
  { href: "/admin/inventory/storefront-enrichment", label: "Enrichment" },
  { href: "/admin/inventory/chloe-edit", label: "Chloe's Edit" },
